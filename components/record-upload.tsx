...
export default function RecordUpload({
  ...
  const submit = () => {
    if (!file) {
      setError("Choose a medical record first.");
      return;
    }
    setBusy(true);
    window.setTimeout(() => {
  ...
  return (
    <>
      <button className="primary hero-action" onClick={() => setOpen(true)}>
        + Add a record
      </button>
          ...
          <section className="upload-modal" role="dialog" aria-modal="true">
            <div className="modal-top">
              <div>
                ...
                <h2>Add a record</h2>
                <p>
                  Upload a report, prescription, discharge summary or other
                  care document.
                </p>
              </div>
            ...
            >
              ...
              <label htmlFor="record-file">
                {file ? (
                    ...
                    <small>
                      {file.type === "application/pdf"
                        ...
                        : file.type.includes("png")
                          ? "PNG"
                          : "JPG"}{" "}· {prettySize(file.size)} · Ready to upload
                    </small>
                  ...
                  <>
                    <span className="upload-symbol">↑</span>
                    <strong>Drop your record here</strong>
                    <small>or click to browse from your device</small>
                    <em>PDF, JPG or PNG · up to 10 MB</em>
                  </>
                )}
              </label>
            </div>
            ...
            <div className="privacy-note">
              ...
              <div>
                ...
                <small>
                  This phase keeps the upload in the current browser session.
            ...
            <div className="modal-actions">
              ...
              <button className="primary upload-submit" disabled={busy} onClick={submit}>
                {busy ? "Adding record…" : "Add record →"}
              </button>
            </div>
          </section>
        </div>
